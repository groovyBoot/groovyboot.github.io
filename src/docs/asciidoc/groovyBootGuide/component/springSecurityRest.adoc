...
[source,groovy]
----
implementation('org.yunchen.gb:gb-plugin-springsecurity-rest:1.3.0')
----
...
----
implementation('org.yunchen.gb:gb-plugin-springsecurity:1.3.0')
implementation('org.yunchen.gb:gb-plugin-springsecurity-rest:1.3.0')
----
